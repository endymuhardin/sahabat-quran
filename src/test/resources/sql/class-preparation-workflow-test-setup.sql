...
INSERT INTO teacher_availability (
    id, id_teacher, id_term, day_of_week, session_time, 
    start_time, end_time, is_available, capacity, 
    max_classes_per_week, preferences, submitted_at
) VALUES
-- Teacher 1: ustadz.ahmad (Morning specialist)
('22345678-2234-5678-9abc-000000000001', '20000000-0000-0000-0000-000000000001', 'D0000000-0000-0000-0000-000000000002', 'MONDAY', 'PAGI_AWAL', '06:00:00', '08:00:00', true, 2, 6, 'CPW_TEST_Early morning preference', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000002', '20000000-0000-0000-0000-000000000001', 'D0000000-0000-0000-0000-000000000002', 'MONDAY', 'PAGI', '08:00:00', '10:00:00', true, 2, 6, 'CPW_TEST_Morning preference', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000003', '20000000-0000-0000-0000-000000000001', 'D0000000-0000-0000-0000-000000000002', 'TUESDAY', 'PAGI', '08:00:00', '10:00:00', true, 2, 6, 'CPW_TEST_Morning preference', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000004', '20000000-0000-0000-0000-000000000001', 'D0000000-0000-0000-0000-000000000002', 'WEDNESDAY', 'PAGI', '08:00:00', '10:00:00', true, 2, 6, 'CPW_TEST_Morning preference', NOW() - INTERVAL '3 days'),

-- Teacher 2: ustadzah.fatimah (Evening specialist)
('22345678-2234-5678-9abc-000000000005', '20000000-0000-0000-0000-000000000002', 'D0000000-0000-0000-0000-000000000002', 'MONDAY', 'SORE', '16:00:00', '18:00:00', true, 1, 5, 'CPW_TEST_Evening specialist', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000006', '20000000-0000-0000-0000-000000000002', 'D0000000-0000-0000-0000-000000000002', 'TUESDAY', 'SORE', '16:00:00', '18:00:00', true, 1, 5, 'CPW_TEST_Evening specialist', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000007', '20000000-0000-0000-0000-000000000002', 'D0000000-0000-0000-0000-000000000002', 'WEDNESDAY', 'SORE', '16:00:00', '18:00:00', true, 1, 5, 'CPW_TEST_Evening specialist', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000008', '20000000-0000-0000-0000-000000000002', 'D0000000-0000-0000-0000-000000000002', 'THURSDAY', 'MALAM', '19:00:00', '21:00:00', true, 1, 5, 'CPW_TEST_Evening specialist', NOW() - INTERVAL '3 days'),

-- Teacher 3: ustadz.ibrahim (Flexible availability)
('22345678-2234-5678-9abc-000000000009', '20000000-0000-0000-0000-000000000003', 'D0000000-0000-0000-0000-000000000002', 'MONDAY', 'SIANG', '10:00:00', '12:00:00', true, 2, 6, 'CPW_TEST_Flexible schedule', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000010', '20000000-0000-0000-0000-000000000003', 'D0000000-0000-0000-0000-000000000002', 'TUESDAY', 'SIANG', '10:00:00', '12:00:00', true, 2, 6, 'CPW_TEST_Flexible schedule', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000011', '20000000-0000-0000-0000-000000000003', 'D0000000-0000-0000-0000-000000000002', 'WEDNESDAY', 'SORE', '16:00:00', '18:00:00', true, 2, 6, 'CPW_TEST_Flexible schedule', NOW() - INTERVAL '3 days'),
('22345678-2234-5678-9abc-000000000012', '20000000-0000-0000-0000-000000000003', 'D0000000-0000-0000-0000-000000000002', 'THURSDAY', 'SORE', '16:00:00', '18:00:00', true, 2, 6, 'CPW_TEST_Flexible schedule', NOW() - INTERVAL '3 days')
ON CONFLICT (id) DO NOTHING;
